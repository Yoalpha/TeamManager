...
function changePlayerRegister() {
 
    // change the document to
    // the GeeksforGeeks homepage
    location.replace(
      "http://localhost:5000/player_register");
}
function changeCoachRegister() {
 
    // change the document to
    // the GeeksforGeeks homepage
    location.replace(
      "http://localhost:5000/coach_register");
}

function changePlayerLogin() {
 
    // change the document to
    // the GeeksforGeeks homepage
    location.replace(
      "http://localhost:5000/player_login");
}
function changeCoachLogin() {
 
    // change the document to
    // the GeeksforGeeks homepage
    location.replace(
      "http://localhost:5000/coach_login");
}